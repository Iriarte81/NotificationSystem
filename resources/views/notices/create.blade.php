...
{!! Form::open(['method' => 'GET', 'action' => 'NoticesController@confirm']) !!}
	...
	<div class="form-group">
		{!! Form::label('original_link', 'To verify that you own the content, we now need the link to the orginal content on the server') !!}
	...
	<div class="form-group">
		{!! Form::submit('Preview Notice', ['class' => 'btn-primary form-control']) !!}
	</div>
